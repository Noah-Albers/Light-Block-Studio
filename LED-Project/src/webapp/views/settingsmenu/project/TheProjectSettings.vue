<template>
    ...
    <div class="d-flex flex-row" style=" min-width: 40vw; min-height: 40vh;">
        <v-tabs v-model="tab" bg-color="#f3f3f3"
            ...
            <v-tab prepend-icon="mdi-text-box"
                text="Template"
                value="template"></v-tab>
        </v-tabs>

        <v-window v-model="tab" style="padding: 20px;">
            <v-window-item value="general">
                <TheGlobalSettings/>
            </v-window-item>

            <v-window-item value="hook">
                <TheHookSettings/>
            </v-window-item>
...
<script setup
    ...
    import TheTemplateSettings from "./TheProjectTemplateSettings.vue";
    import { ref } from 'vue';
