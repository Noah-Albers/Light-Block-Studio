...
storage-desktop_save_error = Failed to save the project. Did your file-extension end in .json? This is required as a security measure. Do you want to retry?
storage-desktop_save_error_no = No
storage-desktop_save_error_yes = Yes
storage-desktop_load_error = Failed to read project file. Please make sure it exists and that is's name ends with '.json
