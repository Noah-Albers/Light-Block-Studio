...
export function registerProcedures() {
    return {
        ...
        setLedRangeSimple: new SimpleProcedure("multi_led", new MultiLedProcCodeConstructor(), new MultiLedProcDiagnostics(), new MultiLedProcLEDNode(), { h: 1, s: 1, v: 1, idxEndExclusive: 16, idxStart: 0,ledDelay: 100 }, MultiLedProcPreparer),
